...
def load_data():
 # declaring and loading files
  call_dataset_name = "Call_data.csv"
  service_dataset_name = "Service_data.csv"
  device_dataset_name = "Device_data.csv"
  
  
  # scope of local variable is to function so we have to make scope global
  global call_data
  #storing it in a variable and making that variable global
...
def openbrowser():
    ...
    webbrowser.open_new('http://127.0.0.1:8050/') #port is given 
...
def create_app_ui():
    ...
    html.H1('CDR Data Analysis and visualisation with Insights by Swagatam Roy', id='Main_title', style={ "color": "black"}),
    ...
    # Footer
     html.Footer(id="footer",
                    ...
                    children=[
                        ...
                        # Name of the creator
                        html.H2(style={"text-align": "center"}, children=[
                            html.H3(children="Made by SWAGATAM ROY ",style={"display": "inline"}),
                        ]),

                        # Email of the creator
                        html.H4(style={"text-align": "center"}, children=[
                            html.H6(children="Email: swagatamr577@gmail.com ,bablaroy577@gmail.com", style={"display": "inline"}),
                        ]),
     ...
     ], style= {'backgroundColor':'Yellow', 'align': 'center', 'textAlign': 'center'})
...
def count_devices(data):
    ...
    # Various devices used for  calls
    ...
    #store and reset index applying chain rule
...
def update_app_ui(Tabs, start_date, end_date, group, report_type, device_date, service_date):
    ...
    if Tabs == "tab-1":
        ...
        # Grouping the data taking into account the dropdown
        #for hourly range   
        ...
        card_3 = create_card("Outgoing Calls", outgoing_calls, "info")
        ...
        card_6 = create_card(title, content, "info")
...
def main():
    #calling load function for loading data 
    load_data()
    #for browser
    openbrowser()
    
    global app, project_name
    print("Start of UI Project")
    project_name = "CDR call data analytics by SWAGATAM ROY"
    ...
    #for freeing the memory allocated to variables
